...
# Define API key
openai.api_key = "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"
...
def generate_response(prompt):
    completions = openai.completions.create(
        ...
        prompt=("following are the questions of a person seeking for legal advice in india give a response as if you are their lawyer "+prompt) ,
        max_tokens=1024,
        n=1,
        stop=None,
        temperature=0.5,
